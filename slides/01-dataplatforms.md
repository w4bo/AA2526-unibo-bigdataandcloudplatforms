...
The main goal of databases in companies has been that of storing *operational data*

- Data generated by operations carried out within business processes
- Computer science was seen as a subsidiary discipline that makes information management faster and cheaper,
- ... but does not create profits in itself
...
- *Facts* of interest are represented in *(hyper) cubes* where:
...
The DFM is a graphical conceptual model for DWH design, devised to:
...
:::{.fragment}
![Corresponding Entity-Relationsip representation](img/cube-dfm.png)
:::
:::
::::
